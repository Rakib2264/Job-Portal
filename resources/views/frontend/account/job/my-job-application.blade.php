                                    ...
                                    <tbody class="border-0">
                                        ...
                                        <tr class="active">
                                            <td>
                                                ...
                                                <div class="info1">{{$jobapplication->job->jobType?->name}}</div>
                                            </td>
                                            <td>{{\Carbon\Carbon::parse($jobapplication->created_at)->format('d M, Y')}}</td>
                                            {{-- <td>{{ $jobApplication->job->applications_count->count() }} Applications</td> --}}
                                            <td>1 Applications</td>
                                            <td>
                                            ...
                                            <td>
                                                <div class="action-dots float-end">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{route('details',$jobapplication->job_id)}}"><i class="fa fa-edit" aria-hidden="true"></i> Edit</a></li>
