                        ...
                        <div class="card-body card-form p-4">
                            ...
                            <div class="mb-4">
                                <label for="" class="mb-2">Expreience</label>
                                 <select name="experience" id="experience" class="form-select">
                                    ...
                                    <option value="0" {{$job->experience == 0 ? 'selected' : ''}}>O Year</option>
                            ...
                            <div class="row">
                                ...
                                <div class="mb-4 col-md-6">
                                    ...
                                    <input type="text" value="{{$job->company_location}}" placeholder="Location" id="company_location" name="company_location"
                                        class="form-control">
                                </div>
                            </div>
