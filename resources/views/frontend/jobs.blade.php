            ...
            <div class="row pt-5">
                <div class="col-md-4 col-lg-3 sidebar mb-4">
                    ...
                    <div class="card border-0 shadow p-4">
                            ...
                            @if ($jobtypes)
                                @foreach ($jobtypes as $jobtype)
                                    <div class="form-check mb-2">
                                        <input {{(in_array($jobtype->id,$jobTypeArray)) ? 'checked':''}} class="form-check-input" value="{{ $jobtype->id }}" id="job_type" name="job_type"
                                            type="checkbox" value="1" id="job-type{{ $jobtype->id }}">
                        ...
                        <a href="{{route('jobs')}}" class="btn btn-sm btn-light mt-2 ">Reset</a>
                    </div>
                </form>
                </div>
